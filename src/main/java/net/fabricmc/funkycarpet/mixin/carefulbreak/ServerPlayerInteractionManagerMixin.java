...
public class ServerPlayerInteractionManagerMixin {
    ...
    private void funkycarpet$carefulBreak$onBreak(Block block, World world, BlockPos pos, BlockState state, PlayerEntity player) {
        try {
    ...
    private boolean funkycarpet$carefulBreak$removeBlock(ServerWorld world, BlockPos pos, boolean move) {
        try {
            CarefulBreakHelper.miningPlayer.set(this.player);
    ...
    private void funkycarpet$carefulBreak$afterBreak(Block block, World world, PlayerEntity player, BlockPos pos, BlockState state, BlockEntity blockEntity, ItemStack stack) {
        try {
            CarefulBreakHelper.miningPlayer.set(this.player);
